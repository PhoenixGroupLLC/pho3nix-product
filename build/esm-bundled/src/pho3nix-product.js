...
if(this._needsShimAdoptedStyleSheets){this._needsShimAdoptedStyleSheets=!1;this.constructor._styles.forEach(s=>{const style=document.createElement("style");style.textContent=s.cssText;this.renderRoot.appendChild(style)})}}/**
   ...
   */LitElement.finalized=!0;/**
      ...
      `]}firstUpdated(){const img=this.imageElement;if(img){img.addEventListener("mousemove",this.onMouseHover);img.addEventListener("mouseleave",this.onMouseLeave)}}disconnectedCallback(){super.disconnectedCallback();const img=this.imageElement;if(img){img.removeEventListener("mousemove",this.onMouseHover);img.removeEventListener("mouseleave",this.onMouseLeave)}}get imageElement(){return this.renderRoot&&this.renderRoot.querySelector("#img")}render(){return html`
        <style>
            #img {
